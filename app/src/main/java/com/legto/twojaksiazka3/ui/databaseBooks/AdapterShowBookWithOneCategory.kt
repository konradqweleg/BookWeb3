...
class AdapterShowBookWithOneCategory(private val context: Activity)
    ...
    override fun getCount(): Int {
        if(listElement==0) {
                try {
                        ...
                        Fuel.get(context.getString(R.string.HOW_MANY_BOOKS_IN_CATEGORY_ADRESS) + CategoryBooks.CategoryChoice.nameBookCategory)
    ...
    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        ...
        if(bookMap.containsKey(position)){
           ...
           Fuel.get(
               context.getString(R.string.GET_BOOK_WITH_ONE_CATEGORY_LIST_ELEM_NUMBER_ADRESS),
               listOf(
